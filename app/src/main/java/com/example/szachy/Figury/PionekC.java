...
public class PionekC
{
    ...
    private String ruch_dwa (String[][] szachownica, int poz_xp, int poz_yp,int poz_xk, int poz_yk)
    {
        try
        {
            if(szachownica[poz_xp+2][poz_yp].equals("xx")&&poz_xp+2==poz_xk&&poz_yp==poz_yk&&poz_xp==1)
            {
                return "ruch_dwa";
            }
            else
    ...
    public String bicie (String[][] szachownica, int poz_xp, int poz_yp,int poz_xk, int poz_yk)
    {
        try
        {
            if(szachownica[poz_xp+1][poz_yp+1].contains("b")&&poz_xp+1==poz_xk&&poz_yp+1==poz_yk)
            {
